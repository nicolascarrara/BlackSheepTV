...
from .views import discoverAPI,FilmList, TrailerFilmAPI, rechercheFilm, rechercheSerie,accueil, SerieList, FilmDetailView, SerieDetailView, SaisonDetailView, EpisodeDetailView,loginAPI
